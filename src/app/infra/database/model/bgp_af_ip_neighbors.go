...
CREATE TABLE `bgp_af_ip_neighbors` (
  ...
  PRIMARY KEY (`id`),
  KEY `bgp_af_ip_neighbors_fabric_id_fkey` (`fabric_id`),
  KEY `bgp_af_ip_neighbors_device_id_fkey` (`device_id`),
  KEY `bgp_af_ip_neighbors_remote_interface_id_fkey` (`remote_interface_id`),
  KEY `bgp_af_ip_neighbors_remote_device_id_fkey` (`remote_device_id`),
  KEY `bgp_af_ip_neighors_af_id_fkey` (`af_id`),
  CONSTRAINT `bgp_af_ip_neighbors_device_id_fkey` FOREIGN KEY (`device_id`) REFERENCES `devices` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bgp_af_ip_neighbors_fabric_id_fkey` FOREIGN KEY (`fabric_id`) REFERENCES `fabrics` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bgp_af_ip_neighbors_remote_device_id_fkey` FOREIGN KEY (`remote_device_id`) REFERENCES `devices` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bgp_af_ip_neighbors_remote_interface_id_fkey` FOREIGN KEY (`remote_interface_id`) REFERENCES `phys_interfaces` (`id`) ON DELETE CASCADE,
  CONSTRAINT `bgp_af_ip_neighors_af_id_fkey` FOREIGN KEY (`af_id`) REFERENCES `bgp_ip_afs` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci

JSON Sample
-------------------------------------
{    "device_id": 82,    "af_id": 47,    "neighbor_afi": "CIqgZZgXMeZkFfHOylaniYZBH",    "remote_asn": 43,    "bfd_rx": 24,    "id": 4,    "fabric_id": 91,    "remote_device_id": 46,    "neighbor_safi": "nfrDIWItyIyOMjtYcYAdvKbHl",    "neighbor_ip_address": "ALlWitdwgAxiKknvHyJYKKAGw",    "bfd_tx": 35,    "bfd_multiplier": 4,    "enable_peer_as_check": 66,    "remote_interface_id": 99,    "e_bgp_mhop": 17,    "is_activated": "MALIjRXQaNlvASmhqSTeAoWlP",    "config_type": "QTgoVfsVByiFLIaIwZMYjAatw",    "peer_group_name": "MyexUpcMHIddIJdmUbOmQcOCX",    "bfd_enable": 43}
...
var bgp_af_ip_neighborsTableInfo = &TableInfo{
	Name: "bgp_af_ip_neighbors",
	Columns: []*ColumnInfo{
...
func (b *BgpAfIPNeighbors) TableInfo() *TableInfo {
	return bgp_af_ip_neighborsTableInfo
}
