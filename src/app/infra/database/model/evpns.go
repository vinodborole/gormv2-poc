...
JSON Sample
-------------------------------------
{    "mac_aging_conversational_timeout": "XgXnZjhOlwJYsmDcpPdtGnmjm",    "duplicate_mac_timer_max_count": "OcpRKrRUfdJdYpvBLuurrLsjd",    "id": 23,    "fabric_id": 17,    "sw_evpn_name": "wLcdRYLfCStlBaqNqPHTRyCtW",    "mac_aging_timeout": "TRiNJLiCUpITGQfwennEbeqHT",    "mac_move_limit": "rnCorCruCwhcZNCOFiaOfFEtV",    "config_type": "nGmCvJmeiEpXbkMMKvCrKGuNQ",    "fabric_name": "nZQrICdKWqQRntUUjeaWDtDnJ",    "device_id": 12,    "device_ip": "dNFAUrnrKXhiHLDLLnCXbSqNs",    "arp_agingtimeout": "LFrGTAybGFDYDYKAVZIPKrCKD",    "duplicate_mac_timer": "jkiXflSYjjXsnwlHmtLCVpdoS"}
