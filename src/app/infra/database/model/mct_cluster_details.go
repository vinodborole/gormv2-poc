...
JSON Sample
-------------------------------------
{    "device_id": 64,    "node_internal_ip": "PGTByMbYBEJMpapPqenFXwIBi",    "node_is_local": "xHWJPGlAAjiHCOSCrZlumdgeK",    "node_condition": "JpvBDHaKWittAyowVoPNvXigC",    "node_switch_type": "AdQSLhrTCJSpdNDPobmGtkYRJ",    "node_id": 82,    "node_status": "TYRNjecdpUpPvLSYsFhndhGun",    "node_mac": "oSohgTLyoluTGUbOQtlgbhCcP",    "id": 60,    "serial_nnum": "qXiVSwCnDLUpPvshOQfSOyrZa",    "principal_switch_mac": "OFsxIcqOxAhjcHmAvbmasPWNg",    "node_public_ip": "LOTBtYKQrvJpvfhByxyQdDiNq",    "node_principal": "iWwmmsiNkdnPhjRVDYNmdRqjg",    "firmware_version": "cjnShOHmLBKENxJRQLMvgneGE"}
