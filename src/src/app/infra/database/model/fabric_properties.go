...
JSON Sample
-------------------------------------
{    "control_vlan": "LspcXffdmAtIMnhAlZfdRSdfb",    "configure_overlay_gateway": "xyNaoGwhhirolQZcKwdlqVKvi",    "bfd_rx": "QqGgXJduvtBbJSMsDcPmDsXkx",    "bfd_multiplier": "neHSjpHuEeDwDqObEGmcajWAS",    "mdtgroup_range": "AiUfvoqHRmQTYnupjXjhRNvma",    "loop_back_port_number": "TMxUKukkKPECgQlnjJpYOAshl",    "leaf_asn_block": "wMRFxkBCpRcDBiFmtHAWiLgVG",    "bfd_tx": "pEwSuiuaNmSKTFLlMIAlBPbyu",    "loop_back_ip_range": "KTwcaDnrSmmRpowmqRHWQKjlQ",    "default_mdtgroup": "ORontJZCMvlepSuLKJmEGiClE",    "id": 13,    "p_2_p_link_range": "wCfJXrTGYDQtJOoiFyhuQyqiZ",    "max_number_of_racks_in_fabric": "LOwkOtxTeZUldRFyKubUXFmlL",    "rack_l_3_back_up_port": "oiSOIcombPDnXvpksHLAfbKgU",    "number_of_devices_in_rack": "NwUpPBpcqARwSlxfoHWYcChIK",    "bfd_enable": "dNefojrXKaxnyrMpklOKLfvLg",    "rack_ld_mct_ports": "bYLDBpLqHEECKrMsJQKIcyxeR",    "backup_routing_enable": "YrQDbRBOnwbDwsgLJehVeiLQF",    "arp_aging_timeout": "nLEHOgkxdjhViIbnQCbWsoaqs",    "control_ve": "OkQPJfsrHkfVqhZQpFgsWtQLV",    "rack_mct_ports": "CfvKkfxaPIZNiUIvxnPTXdhrO",    "optimized_replication_enable": "mVKnVXHVaghahmqUSkPOrsgaT",    "bgp_multi_hop": "IIZQaxMoZqtniqwViOwjRaKlW",    "allow_as_in": "DrYtnXcZEWfiOBjXbIwjKWvKR",    "leaf_peer_group": "hSqQfqbQXaoHYpXLAZlMyLtmb",    "ip_mtu": "dHOQSQGkZIQHOXhLnHqdvagFc",    "super_spine_peer_group": "PMxkkqjnlMEwTMjcWDjhUeeFT",    "rack_ld_l_3_back_up_port": "IZNajXMrDxRTbNiJoQPxhMRuE",    "fabric_id": 86,    "vni_auto_map": "HGpbdFopthkXQRsgDABmlgxqG",    "mtu": "nYoVyTjuHvkoUcbugbuThLYkP",    "mac_aging_conversational_timeout": "cEYDZfPFbwIwGspKbAPOPHlKZ",    "mac_move_limit": "WlgqsqHIrwaptOKhxtFDGgkrx",    "mct_port_channel": "dlYrGdVebgEwJltYgdDGRJTye",    "any_cast_mac": "xbTxfIXYknibgJpkmTZwGTmoa",    "spine_peer_group": "geahVcgnJKXVHPeOFranDiswi",    "p_2_p_ip_type": "MoUdPknaQidwdMuKQTytsTBkU",    "mct_link_ip_range": "XkSrJUZfEpbLkvsXFWIeOJRZA",    "duplicate_mac_timer": "bpFKZhObqQlpNmLZItKVQnJll",    "rack_overlay_ebgp_peer_group": "BrcTTUxKIWPGAZjTdbUffKViK",    "backup_routing_ipv_4_range": "lOKhfvKNhHAbQxmxZaPcyXRLl",    "ip_v_6_any_cast_mac": "WgkUCNYmMloRhuwXjqxJvxRgd",    "max_paths": "HApYwWuCjgSfLIaUbvuSehFkh",    "super_spine_asn_block": "tPyoBBZbIvHmkxIPsdDraLNio",    "spine_asn_block": "rNXpwOqobkHaObjVGCwjUJfyM",    "vtep_loop_back_port_number": "GGHbKsdRFMVyMAOUZsIeNlaRq",    "lacp_timeout": "ucVJCpeSQfVvVlnerDZYTZaFc",    "rack_asn_block": "YgSOikuIKufytqUEiYfFukfRR",    "rack_underlay_ebgp_peer_group": "ugHHiajyBVaJFelhOBZWMNJDB",    "border_leaf_asn_block": "PPtQRcYVaaueGJTKhxUQlQcPG",    "mac_aging_timeout": "NBmvWJQZSfKhMEkpbLjPQJndO",    "duplicate_max_timer_max_count": "HDOxtmMsAotKDqaBHoErlAGKG",    "rack_l_3_back_up_ip_range": "dTYJwSgrEtbIBhQHeTuRKBxom",    "backup_routing_ipv_6_range": "fXdXBFCRsljBaIscAcWhGaUaS"}
