...
JSON Sample
-------------------------------------
{    "p_2_p_link_range": "XrmqgymKMqJwFHSxukJWRXcTU",    "allow_as_in": "PRJOWYTkFVOfcQiHGtMDFdNjo",    "mac_move_limit": "vJSFueGLKmwTtUJiHVfZaHLGO",    "duplicate_mac_timer": "xwZXDpmZpCuGthxipgVvBOVLu",    "optimized_replication_enable": "ZMHaCDSJYfwjLEPPoTEidYqHv",    "leaf_peer_group": "iQyiPMmywpGuZNKjiyHwGkRHL",    "rack_l_3_back_up_ip_range": "mYxOgPTkWQdShNuZKHCpqAfWn",    "mac_aging_timeout": "OmlYxdAvxmEotHQZnrFkYDSdZ",    "rack_ld_mct_ports": "ckDcsOIlDZJFbympbuDQRGEdr",    "loop_back_port_number": "swMDTZHQqohfGIBcloOcoEWJu",    "duplicate_max_timer_max_count": "sUqrSRyMxVPFqLIjCShmQAcYS",    "mct_port_channel": "MxxjNyyaKDSMUaoENsaejKQVd",    "number_of_devices_in_rack": "EGAXaSDGNyOpolutyEFfMGPrQ",    "p_2_p_ip_type": "vfKKmuPRtIxQkRBpxqTHIQxoN",    "super_spine_asn_block": "VmZTojjwRGICxdMjAtMuoUaGi",    "vtep_loop_back_port_number": "ePwTQYHYKPXHZAhTqWsrCFsab",    "mct_link_ip_range": "gewxCqaPVrUtslelPIsqKRlZf",    "spine_peer_group": "EFHtMvrkIpdWNrpTqsGNQBUdw",    "arp_aging_timeout": "uyoZWirkxWpKyXsBShrEmKYLy",    "control_ve": "vLEWOsHimvfwZLHrBCfIkDCBC",    "rack_overlay_ebgp_peer_group": "chbYnsSVGyGXsMyKjneVHUqrv",    "control_vlan": "jgragRajIXFaNGdyAkSIAIMEg",    "fabric_id": 5,    "bfd_multiplier": "upUpopRqYDLKOsKpCBXhuQvme",    "mac_aging_conversational_timeout": "BZfBOJEgPwdWgekNtyCtHLBZb",    "backup_routing_ipv_6_range": "PxSpIMMySoYckEUuCUjMaamkE",    "lacp_timeout": "GhFMqOFwQqaDlVrbJmXbqKJXL",    "ip_v_6_any_cast_mac": "JXtEhRnppmppiiRWrnRqeIftX",    "spine_asn_block": "WlEfvbGaOQBbkCAGwvNmRjEVH",    "bfd_rx": "vOMaBMZpqkHSPNKCprbstngKH",    "rack_l_3_back_up_port": "lpqbuNDZScQtbXDLVLSBBwvOV",    "rack_mct_ports": "YskWvZcnhMjPLJplVpLNMloyO",    "mdtgroup_range": "QZwrluBCxsuAuBycCLpiuvnNW",    "id": 36,    "loop_back_ip_range": "oIJcdfckhckOZajavhHWgMubx",    "leaf_asn_block": "ddAZKQAJdgGaVdNyubrSdBIXu",    "mtu": "HpeIWbMFagJniPALGrOfkBhsh",    "rack_asn_block": "IuJoAXfIfuaNIRNshCCXNQxJA",    "rack_underlay_ebgp_peer_group": "hdhOSQUjSgXcQhmyKHnnqMNFA",    "border_leaf_asn_block": "PPboZHLJJSGhdKOLAdVPGiXbb",    "max_paths": "RLCdKwOgUJQHeCoxtnEehibBC",    "any_cast_mac": "XNkRSYFkKApiFAZQoUhSOOJHI",    "bfd_enable": "jdEYDGFQyLyGaaWolYNKVDHhI",    "ip_mtu": "OgnieZHLxJhmTfUwIbtMaXisE",    "super_spine_peer_group": "qmBcGdTgEkGGbnjOnEfZxhVdh",    "rack_ld_l_3_back_up_port": "ULBUtxiKCpZDjCnQjspAiZESC",    "default_mdtgroup": "FUbJQBkhjsunCbjAltCvmsmGF",    "backup_routing_ipv_4_range": "yEfnFFuTLsvKTmPssnqBJKdZa",    "configure_overlay_gateway": "bxZQIjdEfQmwgdZDTYqVBptlf",    "backup_routing_enable": "WbLVVqdlTDkSVfVBiepBaZRfa",    "max_number_of_racks_in_fabric": "dPskwEUUVDtpjButMfqXdHGhN",    "vni_auto_map": "ptngPVfcaaFQWBsKpbvcupCpK",    "bfd_tx": "eNtHqTvdIbuGfjcSdHEjieRRp",    "bgp_multi_hop": "TPrEsaQUguZDgKfaxCygvDXYE"}
